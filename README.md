...
6.	Edit/Enable Scheduled Job
  ...
  * friendly_froms=[user@example.com - this is case-sensitive and must match the CiviCRM from address; it can be a comma separated list of email addresses]
  * events=[leave defaults, removing “- required”]   
